...
public class NikelArmor extends ItemArmor{

	private String texturePatch ="mods:";
	private String iconPath = "mods:";
	
	public NikelArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3,
	...
	private void SetArmorType(String type, int par4) 
	{
		...
		{
		case 0:
			this.setUnlocalizedName(type + "Nikel Helmet");
			this.texturePatch += type + "_layer_1.png";
			this.iconPath +=type + "nikel_helmet";
			break;
		case 1:
			this.setUnlocalizedName(type + "Nikel Chest");
			this.texturePatch += type + "_layer_1.png";
			this.iconPath +=type + "nikel_chest";
			break;
		case 2:
			this.setUnlocalizedName(type + "Nikel Leggings");
			this.texturePatch += type + "_layer_2.png";
			this.iconPath +=type + "nikel_leggings";
			break;
		case 3:
			this.setUnlocalizedName(type + "Nikel Boots");
			this.texturePatch += type + "_layer_1.png";
			this.iconPath +=type + "nikel_boots";
			break;
